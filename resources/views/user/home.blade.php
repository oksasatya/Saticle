                            ...
                            @else
                                <a class="postcard__img_link" href="#">
                                    <img class="postcard__img"
                                        src="https://source.unsplash.com/1000x1000?{{ $post->title }}"
                                        alt="{{ $post->title }}" />
                                </a>
                            @endif
                                ...
                                <ul class="postcard__tagbox">
                                    ...
                                    @foreach ($post->tags as $tag)
                                        @if ($loop->iteration % 2 == 0)
                                            <li class="tag__item"><i class="fa fa-tag me-2"></i>{{ $tag->name }}
                                            </li>
                                        @endif
                                    @endforeach
                                    <li class="tag__item"><i class="fa fa-user me-2"></i>{{ $post->author }}</li>
                                    <li class="tag__item play blue">
                                        <a href="#"><i class="fa fa-play me-2"></i><span class="text-white">Read
                                                More</span></a>
                                    </li>
                                </ul>
                            </div>
